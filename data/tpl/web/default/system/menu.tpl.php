				...
				<li class="menu-item">
					<div class="table-div table-div-menu">
						...
						<div class="table-div__item display">
							<?php  if(in_array($permission_name, array('appmarket', 'site'))) { ?>
					...
					<ul class="two">
						...
						<li class="menu-item">
							<div class="table-div table-div-menu">
								...
								<div class="table-div__item display">
									<?php  if(in_array($section_name, array('account', 'wxapp', 'xzapp', 'phoneapp', 'webapp', 'aliapp'))) { ?>
										...
										<li class="menu-item ">
											<div class="table-div table-div-menu">
												...
												<div class="table-div__item display">
													...
													<span class="color-gray">默认开启</span>
													<?php  } else { ?>
													<span class="switch" ng-init="displayStatus['<?php  echo $sub_menu_permission_name;?>'] = <?php echo $sub_menu_permission['is_display'] ? 'true' : 'false'?>" ng-click="changeDisplay('<?php  echo $sub_menu_permission['permission_name'];?>')" ng-class="{'switchOn' : displayStatus['<?php  echo $sub_menu_permission_name;?>'], 'switchOff' : !displayStatus['<?php  echo $sub_menu_permission_name;?>']}"></span>
													<?php  } ?>
												</div>
												<div class="table-div__item action">
													<div class="link-group">
