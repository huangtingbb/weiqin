...
use App\Domain\Category as DomainCURD;
use PhalApi\Api;
    ...
    public function getRules()
    {
        return array(
            'insert' => array(
                ...
                'name' => array('name' => 'name', 'require' => false, 'type' => 'string', 'default' =>'', 'desc' => 'name'),
                'id' => array('name' => 'id', 'require' => false, 'min' => 1, 'desc' => 'ID'),
            ),
            'update' => array(
                'sort' => array('name' => 'sort', 'require' => false, 'type' => 'int', 'min' => 1, 'desc' => '排序'),
                'url' => array('name' => 'name', 'require' => true, 'type' => 'string', 'default' =>'', 'desc' => '要打开的文章连接'),
                'img' => array('name' => 'img', 'require' => false, 'type' => 'string', 'default' =>'', 'desc' => '图片'),
                'name' => array('name' => 'name', 'require' => false, 'type' => 'string', 'default' =>'', 'desc' => 'name'),
                'id' => array('name' => 'id', 'require' => false, 'min' => 1, 'desc' => 'ID'),
            ),
