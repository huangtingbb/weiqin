...
use App\Domain\Wokers as DomainCURD;
use PhalApi\Api;
    ...
    public function getRules()
    {
        return array(
            'insert' => array(
                ...
                'price' => array('name' => 'price', 'require' => false, 'type' => 'string', 'default' =>'', 'desc' => '价格'),
                'serviceData' => array('name' => 'serviceData', 'require' => false, 'type' => 'string', 'default' =>'', 'desc' => '服务'),
                'introduction' => array('name' => 'introduction', 'require' => false, 'type' => 'string', 'default' =>'', 'desc' => '自我介绍'),
                'phone' => array('name' => 'phone', 'require' => false, 'type' => 'string', 'default' =>'', 'desc' => '电话'),
                'name' => array('name' => 'name', 'require' => true, 'type' => 'string', 'default' =>'', 'desc' => '姓名'),
                'map' => array('name' => 'map', 'require' => false, 'type' => 'string', 'default' =>'', 'desc' => '服务范围'),
            ...
            'update' => array(
                ...
                'introduction' => array('name' => 'introduction', 'require' => false, 'type' => 'string', 'default' =>'', 'desc' => '自我介绍'),
                'phone' => array('name' => 'phone', 'require' => false, 'type' => 'string', 'default' =>'', 'desc' => '电话'),
                'name' => array('name' => 'name', 'require' => false, 'type' => 'string', 'default' =>'', 'desc' => '姓名'),
                'map' => array('name' => 'map', 'require' => false, 'type' => 'string', 'default' =>'', 'desc' => '服务范围'),
            ),
            'get' => array(
                'id' => array('name' => 'id', 'require' => false, 'min' => 1, 'desc' => 'ID'),
