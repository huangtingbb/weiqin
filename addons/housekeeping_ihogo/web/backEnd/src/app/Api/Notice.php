...
use App\Domain\Notice as DomainCURD;
use PhalApi\Api;
...
class Notice extends Base
{
    ...
    public function getRules()
    {
        return array(
            'insert' => array(
                'url' => array('name' => 'url', 'require' => false, 'type' => 'string', 'default' => '', 'desc' => '地址'),
                'title' => array('name' => 'title', 'require' => true, 'type' => 'string', 'default' =>'', 'desc' => '通知标题'),
            ),
            'update' => array(
